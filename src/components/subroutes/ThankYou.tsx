const ThankYou = () => {
  return (
    <div className="w-full flex justify-center items-center h-[550px] flex-col gap-8">
      <svg
      ...
      <h4 className="font-bold text-sky-950 text-4xl">Thank You!</h4>
      <p className="text-base block text-slate-500 text-center">
